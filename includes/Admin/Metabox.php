        ...
        ->add_fields( array(
            Field::make( 'select', '_review_winner_option', __( 'Choose Review Winner' ) )
                ->add_options( array(
                        ...
                        'first'       => __( 'First Winner', 'wbr' ),
                        'second'      => __( 'Second Winner', 'wbr' ),
                        'third'       => __( 'Third Winner', 'wbr' ),
                        'fourth'      => __( 'Fourth Winner', 'wbr' ),
                        'fifth'       => __( 'Fifth Winner', 'wbr' ),
                        'sixth'       => __( 'Sixth Winner', 'wbr' ),
                        'seventh'     => __( 'Seventh Winner', 'wbr' ),
                        'eighth'      => __( 'Eighth Winner', 'wbr' ),
                        'ninth'       => __( 'Ninth Winner', 'wbr' ),
                        'tenth'       => __( 'Tenth Winner', 'wbr' ),
                        'eleventh'    => __( 'Eleventh Winner', 'wbr' ),
                        'twelfth'     => __( 'Twelfth Winner', 'wbr' ),
                        'thirteenth'  => __( 'Thirteenth Winner', 'wbr' ),
                        'fourteenth'  => __( 'Fourteenth Winner', 'wbr' ),
                        'fifteenth'   => __( 'Fifteenth Winner', 'wbr' ),
                        'sixteenth'   => __( 'Sixteenth Winner', 'wbr' ),
                        'seventeenth' => __( 'Seventeenth Winner', 'wbr' ),
                        'eighteenth'  => __( 'Eighteenth Winner', 'wbr' ),
                        'nineteenth'  => __( 'Nineteenth Winner', 'wbr' ),
                        'twentieth'   => __( 'Twentieth Winner', 'wbr' ),
                ) ),
